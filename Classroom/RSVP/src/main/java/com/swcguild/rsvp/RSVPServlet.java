...
public class RSVPServlet extends HttpServlet {//SERVLET IS A POJO- Plain Old Java
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("No".equals(myAnswer) && myReason.equals(response)) 
        {
            message = "well eff you buddy";

        } else if ("No".equals(myAnswer)) {
            message = "sorry you can't make it";

        } else {
            message = "Can't wait to see you, boo!";
        }
