...
///AJAX BEGINS
    ...
    @ResponseBody
    public DVD getDvd(@PathVariable("dvdId") int id) {
    ...
    @ResponseBody
    public DVD createDvd(@Valid @RequestBody DVD ll) {
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void putDvd(@PathVariable("id") int id, @RequestBody DVD ll) {///imports 
        ll.setId(id);
